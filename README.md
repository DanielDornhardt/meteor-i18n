...
Migrating From leesangwon:mira-i18n
-----------------------------------

Using I18n.registerLanguage & I18n.addPartial methods,
just change the parameter 'mapName' from object to object name:
